        ...
        <div className='containerHead'>
          ...
          <div className='description' data-aos="fade-up">
            ...
            <img src={image1} alt="Web Site image" />
                <p>This project was created with React JS, using localStorage, usesState, styled components. The project serve like a spent planner, you can add more money, filter expenses by category, add, delet and edit (CRUD) expenses.</p>
